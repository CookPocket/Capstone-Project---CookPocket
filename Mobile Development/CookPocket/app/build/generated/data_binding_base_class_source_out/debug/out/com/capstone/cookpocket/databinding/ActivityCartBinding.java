...
public final class ActivityCartBinding implements ViewBinding {
  ...
  private ActivityCartBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivBackCart,
      @NonNull ConstraintLayout main, @NonNull TextView tvCart) {
  ...
  public static ActivityCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCartBinding((ConstraintLayout) rootView, ivBackCart, main, tvCart);
    }
