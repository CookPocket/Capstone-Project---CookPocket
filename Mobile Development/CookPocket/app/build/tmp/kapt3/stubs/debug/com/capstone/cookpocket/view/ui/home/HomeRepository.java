...
public final class HomeRepository {
    ...
    @org.jetbrains.annotations.NotNull()
    private final androidx.lifecycle.MutableLiveData<java.util.List<com.capstone.cookpocket.Network.Response.ListStoryItem>> _allStories = null;
    @org.jetbrains.annotations.NotNull()
    private final androidx.lifecycle.MutableLiveData<java.util.List<com.capstone.cookpocket.Network.Response.ListStoryItem>> _filteredStories = null;
    @org.jetbrains.annotations.NotNull()
    private final androidx.lifecycle.LiveData<java.util.List<com.capstone.cookpocket.Network.Response.ListStoryItem>> filteredStories = null;
    @kotlin.jvm.Volatile()
    ...
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<java.util.List<com.capstone.cookpocket.Network.Response.ListStoryItem>> getFilteredStories() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final kotlinx.coroutines.flow.Flow<androidx.paging.PagingData<com.capstone.cookpocket.Network.Response.ListStoryItem>> getPagedStories(@org.jetbrains.annotations.Nullable()
    java.lang.String query) {
        return null;
    }
